        ...
        <tr align="left" valign="top"> 
          ...
          <td width="450" height="300"><img src="templates/images/border_content_bottom.gif" width="450" height="20"><br>
			...
			<!-- This is where the content starts -->
				<span class="content_headline">Become a Member!</span><br><br>
				Your password and further information on how to log in were sent to your email account. Please allow for some minutes!
				<br><br>
				Go to <a href="index.php" class="content_link">Login</a> to access the network.
