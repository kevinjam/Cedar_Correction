...
<div class="body"> 
  ...
  <tr> 
    ...
    <span class="content_headline">Jobfair</span><br><br>
    This is the place where you can search or offer jobs, placements or internships.
    <br><br>
                  <table width="100%">
                    <tr>
                      <td><b>Date</b></td>
                    ...
                    <!-- BEGIN TPL_ROW -->
                    <tr>
                      <td><span  class="content_link">{JOB_DATE}</td>
                      <td>{JOB_INDUSTRY}</td>
                      <td>{JOB_TITLE}</td>
                      <td>{JOB_EXPERIENCE} Years</td>
                    </tr>
                    <!-- END TPL_ROW -->
                  </table>
    <p align="right">
    <br>
    <a href="jobfair_index.php?display=all"><img src="../templates/images/show_all.gif" border="0"></a>&nbsp;&nbsp;<a href="jobfair_index.php?display=latest_10"><img src="../templates/images/latest_10.gif" border="0"></a>&nbsp;&nbsp;<a href="jobfair_add.php"><img src="../templates/images/add.gif" border="0"></a>
    </p>
