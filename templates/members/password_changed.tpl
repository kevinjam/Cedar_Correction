...
<div class="body"> 
  ...
  <tr> 
    ...
    Your password was changed successfully. Please press OK to proceed to the homepage.

                  <p align="right"><a href="index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
