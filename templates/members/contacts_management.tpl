...
<div class="body"> 
  ...
  <tr> 
    ...
    The action was successfully completed. Please press OK to proceed to the contact list.
    <br><br>
                  <p align="right"><a href="contacts_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
                  <p>
