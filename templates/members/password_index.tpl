...
<div class="body"> 
  ...
  <tr> 
    ...
    <span class="content_headline">Change Password</span><br><br>
    Please enter your new password in both fields and press OK.
    <p>
    Your new password has to have <b>at least {PW_LENGTH} characters</b>!
    <br><br><br>
                  <form action="password_changed.php" method="POST">
                    Old Password:<br>
                      <input name="password_old" type="password" size="20" maxlength="20">
                      <br>
                    New Password:<br>
                      <input name="password_new" type="password" size="20" maxlength="20">
                      <br>
                      Confirm New Password:<br>
                      <input name="password_new_check" type="password" size="20" maxlength="20">
      <br><br>
                      <input type="image" src="../templates/images/ok.gif" name="Submit" border="0">
                  </form><br><br>
