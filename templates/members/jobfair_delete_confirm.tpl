  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="center" style="margin:0 auto; width:960px;">
		...
		<span class="content_headline">Delete Job Offer</span><br><br>
		Please confirm the deletion of your job offer.
		<br>
                  <p align="right"><img src="../templates/images/back.gif" border="0"  onClick="history.go(-1)">&nbsp;&nbsp;{OK_BUTTON} </span>
