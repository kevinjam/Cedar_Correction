...
<div class="body"> 
  ...
  <tr> 
    ...
    <span class="content_headline">Tell a Friend!</span><br><br>
    An invitation with your best wishes was sent to {FIRST_NAME} {LAST_NAME}. Press OK to proceed to the homepage.
    <br><br>
    <p align="right"><a href="index.php"><img src="../templates/images/ok.gif" border="0" alt="OK"></a></p>
