...
<div class="body"> 
  ...
  <tr> 
    ...
    <span class="content_headline">Member Details</span><br><br>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" valign="top">
                    ...
                    <tr> 
                      <td>Cellphone:</td>
                      <td>{COMPANY_CELLPHONE} </td>
                    </tr>
                    <tr> 
                      <td>Homepage:</td>
                      <td>{COMPANY_HOMEPAGE}</td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      <td>Other Info:</td>
                      <td>{COMPANY_OTHER_INFO}</td>
                    </tr>
                  </table>
      <br>
                  <p align="right"><img src="../templates/images/back.gif" onClick="history.go(-1)"></p>
