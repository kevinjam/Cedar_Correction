...
<div class="body"> 
  ...
  <tr> 
    <td align="left" valign="top"> 
      ...
      {NAVIGATION}
            <img src="../templates/../templates/images/border_navigation.gif" width="150" height="20">
          </td>
    ...
    <span class="content_headline">Confirm Contact Request.</span><br><br>
    Please confirm your contact request. A mail will be sent to the respective member to inform her/him about your request.
    <br><br>
    <p align="right"><input type="image" src="../templates/images/back.gif" border="0" onClick="history.go(-1)" name="image2">&nbsp;&nbsp;{OK_BUTTON}</p>
