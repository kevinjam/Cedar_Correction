...
<div class="body"> 
  ...
  <tr>
    ...
    <span class="content_headline">Contact Request Sent.</span><br><br>
    Your contact request was sent to the respective member. It may take a while until the member reads the email and accepts your request.
    <br><br>
    <p align="right">{OK_BUTTON}</p>
