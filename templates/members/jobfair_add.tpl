...
<div class="body"> 
  ...
  <tr> 
    ...
    <span class="content_headline">Add new Job!</span><br><br>
    Complete the fields below to add a new job to the jobfair_index.
    <br><br>
                  <form action="jobfair_add_ok.php" method="POST">
                    <table width="100%" border="0" class="text">
                      ...
                      <tr valign="top">
                        <td>Industry:</td>
                        <td>
                          <input name="job_industry" type="text" size="30" maxlength="30">
                        </td>
                      </tr>
                      <tr valign="top">
                        <td>Title:</td>
                      ...
                      <tr valign="top">
                        <td>Salary:</td>
                        <td>
                          <input name="salary" type="text" size="30" maxlength="20">
                        </td>
                      </tr>
                      <tr valign="top">
                        <td>City:</td>
                      ...
                      <tr valign="top">
                        <td>Description:</td>
                        <td>
                          <textarea name="description" wrap="virtual" cols="30" rows="5"></textarea>
        <br>
        <br>
                        </td>
                      </tr>
                      <tr valign="top">
                        <td>Prerequisites:</td>
                        <td>
                          <textarea name="prerequisites" wrap="virtual" cols="30" rows="5"></textarea>
        <br>
        <br>
                        </td>
                      </tr>
                      <tr valign="top">
                        <td>Benefits:</td>
                        <td>
                          <textarea name="benefits" wrap="virtual" cols="30" rows="5"></textarea>
        <br>
        <br><br>
                        </td>
                      </tr>
                      ...
                      <tr valign="top">
                       ...
                       <tr valign="top">
                        <td>Contact:</td>
                        <td>
                          <input name="contact" type="text" size="30" maxlength="40">
                        </td>
                      </tr>
          <tr align="right"><td>&nbsp;</td><td>
                    <br>
                    <input type="image" src="../templates/images/add.gif" name="Add" border="0">
        <br><br>
        </td></tr>
                   </table>
                  </form>
