        ...
        <tr align="left" valign="top"> 
          ...
          <td width="450" height="300"><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="6" class="content_text">
              <tr> 
                <td class="text" align="left" valign="top" style="padding-left:25px;"> 
			<!-- This is where the content starts -->
				<span class="content_headline">Lost your password?</span><br><br>
				Please enter the email address you used for signing-in. A new password will be sent to your mailaccount in a few minutes!
				<br><br>
				<form action="lost_password_ok.php" method="POST">
				<p>Email:<br>
				<input name="email" type="text" size="30" maxlength="30">
				<br><br>
				<input type="image" src="templates/images/ok.gif" border="0" name="image">
				</p>
				</form>
