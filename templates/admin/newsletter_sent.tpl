  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Newsletter Sent</span><br><br>
		The newsletter was successfully sent! Please press OK to proceed to the newsletter index.
		<br><br>
		<p align="right"><a href="newsletter_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
                    </span>
