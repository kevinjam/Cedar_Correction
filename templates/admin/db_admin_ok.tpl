  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Optimize Database</span><br><br>
		The action was performed successfully. Please press OK to proceed to the database admin.
		<br><br>
		<p align="right"><a href="db_admin_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
