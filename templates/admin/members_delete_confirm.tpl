  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Confirm Member Deletion</span><br><br>
		Do you really want to delete this member? Please press OK to confirm.
		<br><br>
                <p align="right"><input type="image" src="../templates/images/back.gif" onClick="history.go(-1)" name="image" border="0">&nbsp;&nbsp;{CONFIRM_DELETE}</p>
