      ...
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
        <tr align="left" valign="top"> 
          ...
          <td width="450" height="300"><img src="../templates/images/border_content_bottom.gif" width="450" height="20"><br>
			...
			The subgroup was deleted successfully. Press OK to proceed to the preferences_index.
			<br><br>
			<p align="right"><a href="preferences_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
