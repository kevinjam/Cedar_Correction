  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		The news item was deleted successfully. Please press OK to preceed to the newsflash page.
		<br><br>
                    <p align="right"><a href="news_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
