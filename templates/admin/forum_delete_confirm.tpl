  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Delete</span><br><br>
		Are you shure, you want to delete this entry? If you delete a whole forum or a thread, all messages below will be deleted as well. Press OK to confirm!
		<br><br>
