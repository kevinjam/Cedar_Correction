  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Delete Subgroup</span><br><br>
		Please confirm the deletion of the subgroup. The member information of all members in this subgroup will not be touched by this operation. Press OK to confirm.
		<br><br>
		<p align="right"><input type="image" src="../templates/images/back.gif" border="0" onClick="history.go(-1)" name="back">&nbsp;&nbsp;{OK_BUTTON}</p>
