  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		The element was deleted successfully. Please press OK to proceed to the forum index.
		<br><br>
		<p align="right"><a href="forum_index.php"><img src="../templates/images/ok.gif" border="0"></a></p>
