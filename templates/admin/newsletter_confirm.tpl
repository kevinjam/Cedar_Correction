  ...
  <tr> 
    <td align="left" valign="top"> 
      <table width="740" border="0" cellspacing="0" cellpadding="0" height="300" align="left">
		...
		<span class="content_headline">Check Email Newsletter</span><br><br>
		Please check the newsletter before sending it out.
		<br><br><br>
		  <table width="100%" class="content_text" >
                    <tr><td bgcolor="#69A5A5"><font color="#FFFFFF"><b>{SUBJECT}</b></font></td></tr>
		    <tr><td><b>Recipients:&nbsp;</b>{RECIPIENTS_LIST}<hr width="20%"></td></tr>
		    <tr><td width="400">{BODY}</td></tr>
                  </table>
		  <br><br>
		 <p align="right"> <img src="../templates/images/back.gif" border="0"  onClick="history.go(-1)">&nbsp;&nbsp; <a href="newsletter_sent.php"><img src="../templates/images/ok.gif" border="0"></a></p>
