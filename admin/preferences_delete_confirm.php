...
// reminds the user that s/he is about to delete a subgroup from the DB
...
$t->set_file(array("PAGE" => "preferences_delete_confirm.tpl",
			"HEADER" => "header.tpl",
			"SPONSORS" => "sponsors.tpl",
			"NAVIGATION" => "navigation.tpl",
			"FOOTER" => "footer.tpl"));

$t->set_var("OK_BUTTON", "<a href=preferences_delete_ok.php?subgroup_id=".$subgroup_id."><img src=../templates/images/ok.gif border=0></a>");
