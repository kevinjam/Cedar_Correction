...
// reminds the user that s/he is about to delete an article from frontpagenews
...
$t->set_file(array("PAGE" => "news_delete_confirm.tpl",
			"HEADER" => "header.tpl",
			"SPONSORS" => "sponsors.tpl",
			"NAVIGATION" => "navigation.tpl",
			"FOOTER" => "footer.tpl"));

$t->set_var("OK_BUTTON", "<a href=news_delete_ok.php?news_id=".$news_id."><img src=../templates/images/ok.gif border=0></a>");
