...
// reminds the user that s/he is about to delete an entry in the forums
...
$t->set_file(array("PAGE" => "forum_delete_confirm.tpl",
			"HEADER" => "header.tpl",
			"SPONSORS" => "sponsors.tpl",
			"NAVIGATION" => "navigation.tpl",
			"FOOTER" => "footer.tpl"));

$t->set_var("OK_BUTTON", "<a href=forum_delete_ok.php?action=".$action."&id=".$id."><img src=../templates/images/ok.gif border=0></a>");
